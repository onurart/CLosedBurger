...
namespace ClosedBurger.Client.Areas.Admin.Controllers
{
    ...
    public class AboutsController : Controller
    {
        ...
        public AboutsController(CloseBurgerDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Title,Explanation,Id")] About about)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Title,Explanation,Id")] About about)
        {
            if (id != about.Id)
            {
                return NotFound();
